                    ...
                    <nav class="mt-6">
                        <div>
                            ...
                            <NuxtLink
                                ...
                                <span class="mx-4 text-sm font-normal">tasks</span>
                            </NuxtLink>
                            <NuxtLink
                                class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800"
                                to="/dashboard/books">
                            ...
                            <a class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800"
                                href="#">
                                <span class="text-left">
                                    <svg width="20" height="20" fill="currentColor" class="m-auto"
                                        viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
