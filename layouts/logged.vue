    ...
    <main class="bg-gray-100 dark:bg-gray-800 h-screen overflow-hidden relative">
        <div class="flex items-start justify-between">
            <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
                <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                        ...
                        <svg width="35" height="30" viewBox="0 0 256 366" version="1.1" preserveAspectRatio="xMidYMid">
                            ...
                            <g>
                                ...
                                <circle fill="url(#linearGradient-1)"
                                    ...
                                    cx="147.013244" cy="147.014675" r="78.9933938"></circle>
                    ...
                    <nav class="mt-6">
                        <div>
                            <NuxtLink
                                class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800"
                                href="/dashboard">
                            ...
                            <NuxtLink class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800" href="/dashboard/mytask">
                                <span class="text-left">
                            ...
                            <NuxtLink class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800" href="/dashboard/books">
                                <span class="text-left">
                                    <svg width="20" height="20" fill="currentColor" class="m-auto"
                                        viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <span class="mx-4 text-sm font-normal">Book</span>
                            </NuxtLink>
                            <NuxtLink class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800" href="/dashboard/manage-user">
                                <span class="text-left">
                                ...
                                <span class="mx-4 text-sm font-normal">Manage user</span>
                            </NuxtLink>
                            <a class="w-full font-thin uppercase text-blue-500 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800" href="#">
                                <span class="text-left">
                                    <svg width="20" height="20" fill="currentColor" class="m-auto"
                                        viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
                <header class="w-full shadow-lg bg-white dark:bg-gray-700 items-center h-16 rounded-2xl z-20">
                    <div class="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
                        <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                            <div class="container relative left-0 z-50 flex w-3/4 h-full">
                                <div class="relative flex items-center w-full lg:w-64 h-full group">
                                    <div
                                        class="absolute z-50 items-center justify-center block w-auto h-10 p-3 pr-2 text-sm text-gray-500 uppercase cursor-pointer sm:hidden">
                                        <svg fill="none" class="relative w-5 h-5" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                ...
                <div class="overflow-auto h-screen pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0 text-gray-600">
                    <slot />
                </div>
            </div>
        </div>
